...
from detector.image_preprocess import extract, scale_and_centre, order_corner_points
...
def extract_number_image(img_grid, model_path):
    ...
    for i in range(9):
        for j in range(9):
            ...
            for c in cnts:
                ...
                tmp_sudoku[i][j] = predict(ROI, model_path)
    return tmp_sudoku


def predict(img_grid, model_path):
    image = img_grid.copy()
